...
public class ChangeTaskAccessRightsValidationDriverScript extends ReportGenerator{

	static Logger log = Logger.getLogger("ChangeTaskAccessRightsValidationDriverScript");
	private static ExtentTest report = null;
	private String objectType = Config.CHANGE_TASK;	
	...
	String excelInput = Config.SSO_NEXTGEN_ACCESS_RIGHTS_MANAGEMENT_RESULT_FILE_PATH_CHANGE_TASK;
	...
	@Test
	public void TestAllAccessRightsAutomationForChangeTask() throws Exception {
		log.info("####################### "+objectType+ "Driver Script execution started  ##################################"  );
		
		int ChangeTaskInitialRownumber = Config.changeTaskSuiteInitialRowNumber-1;
		for (int i = ChangeTaskInitialRownumber; i <= excel.getRowCount(sheetName); i++) {
		...
		//	String AdministrativeAccess = excel.getData(Object, i, "Administrative").trim();
			...
			String[] validationResult  = ChangeTaskSuite.verifyCreateAccessRightValidationforChangeTask(Config.CHANGE_NOTICE, Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, "Open", Config.CHANGENOTICE_FOR_CHANGETASK);
			...
			String[] validationResult  = ChangeTaskSuite.verifyReadChangeTaskAccessRightValidation(Config.CHANGE_NOTICE, Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, "Open", Config.CHANGENOTICE_FOR_CHANGETASK, status);
			...
			String[] validationResult  = ChangeTaskSuite.verifyModifyChangeTaskAccessRightValidation(Config.CHANGE_NOTICE, Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, "Open", Config.CHANGENOTICE_FOR_CHANGETASK, status);
			...
			if (setStateAccess.equalsIgnoreCase("NA")) {
				...
				String[] validationResult  = ChangeTaskSuite.setStateChangeTaskAccessRightValidation(Config.CHANGE_NOTICE, Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, "Open", Config.CHANGENOTICE_FOR_CHANGETASK, status);
	...
	// Create by move Access Permission is Not Applicable for Change Task
	...
	// Download Access Permission is Not Applicable for Change Task
	...
	// Modify Identity Access Permission is Not Applicable for Change Task
	...
	//Modify Content Access Permission is Not Applicable for Change Task
	...
	// revise Access Permission is Not Applicable for Change Task
	...
	// Delete Access Permission is Not Applicable for Change Task
   ...
   // Change Context Access Permission is Not Applicable for Change Task
	...
	// Change Domain Access Permission is Not Applicable for Change Task
