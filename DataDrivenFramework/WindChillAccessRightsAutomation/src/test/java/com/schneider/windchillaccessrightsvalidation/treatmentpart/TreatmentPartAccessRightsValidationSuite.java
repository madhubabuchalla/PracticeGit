...
public class TreatmentPartAccessRightsValidationSuite {
	static Logger log = Logger.getLogger("TreatmentPartAccessRightsValidationSuite");
	WindChillAccessRightsValidationUtil windChillUtil = new WindChillAccessRightsValidationUtil();

	public static String objectType = Config.TREATMENT_PART;
	public static String objectName = Config.TREATMENT_PART_NAME;
	String[] createAccessRight = new String[2];
	String createOption = "";

	
	public String[] verifyCreateAccessRightForTreatmentPart() throws Exception {
		...
		createAccessRight = windChillUtil.createTreatmentPartAccessRightValidation(objectType);
	...
	public String[] verifyReadAccessRightForTreatmentPart(String ADV_OBJECT_TYPE,String ADV_SEARCH_CONTAINER_NAME, String currentTemplate, String ADV_SEARCH_STATE_STATUS, String ADV_SEARCH_BY_NAME) throws InterruptedException {
	...
	public String[] verifyModifyAccessRightForTreatmentPart(String ADV_OBJECT_TYPE,String ADV_SEARCH_CONTAINER_NAME, String currentTemplate, String ADV_SEARCH_STATE_STATUS, String ADV_SEARCH_BY_NAME) throws InterruptedException {
	...
	public String[] verifyModifyIdentityAccessRightForTreatmentPart(String ADV_OBJECT_TYPE,String ADV_SEARCH_CONTAINER_NAME, String currentTemplate, String ADV_SEARCH_STATE_STATUS, String ADV_SEARCH_BY_NAME) throws InterruptedException {
	...
	public String[] verifySetStateAccessRightForTreatmentPart(String ADV_OBJECT_TYPE,String ADV_SEARCH_CONTAINER_NAME, String currentTemplate, String ADV_SEARCH_STATE_STATUS, String ADV_SEARCH_BY_NAME) throws InterruptedException {
	...
	public String[] verifyChangeContextAccessRightForTreatmentPart(String ADV_OBJECT_TYPE,String ADV_SEARCH_CONTAINER_NAME, String currentTemplate, String ADV_SEARCH_STATE_STATUS, String ADV_SEARCH_BY_NAME) throws InterruptedException {
	...
	public String[] verifyChangeDomainAccessRightForTreatmentPart(String ADV_OBJECT_TYPE,String ADV_SEARCH_CONTAINER_NAME, String currentTemplate, String ADV_SEARCH_STATE_STATUS, String ADV_SEARCH_BY_NAME) throws InterruptedException {
	...
	public String[] verifyReviseAccessRightForTreatmentPart(String ADV_OBJECT_TYPE,String ADV_SEARCH_CONTAINER_NAME, String currentTemplate, String ADV_SEARCH_STATE_STATUS, String ADV_SEARCH_BY_NAME) throws InterruptedException {
	...
	public String[] verifyDeleteAccessRightForTreatmentPart(String ADV_OBJECT_TYPE,String ADV_SEARCH_CONTAINER_NAME, String currentTemplate, String ADV_SEARCH_STATE_STATUS, String ADV_SEARCH_BY_NAME) throws InterruptedException {
