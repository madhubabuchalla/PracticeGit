...
public class ManagedCollectionAccessRightsValidationDriverScript extends ReportGenerator{
static Logger log = Logger.getLogger(ManagedCollectionAccessRightsValidationDriverScript.class);
private static ExtentTest report = null;
private String objectType = Config.MANAGED_COLLECTION;
private String sheetName = Config.SSO_USER_ROLE.trim();
String objectName = null;
String status = null;
String ADVANCE_SEARCH_BY_NAME = Config.MANAGED_COLLECTION_NAME;
...
String excelInput = Config.SSO_NEXTGEN_ACCESS_RIGHTS_MANAGEMENT_RESULT_FILE_PATH_MANAGED_COLLECTION;
...
@Test
public void TestAllAccessRightsAutomationForManagedCollection() throws Exception {

	log.info("####################### "+objectType+ "Driver Script execution started  ##################################"  );
	
	int initialRowNumber = Config.managedCollectionSuiteInitialRowNumber-1;
...
if(createAccess.equalsIgnoreCase("NA")){
			...
			String[] validationResult = ManagedCollectionSuite.verifyCreateAccessRightForManagedCollection();
		...
		// Read Access Validation Script will execute 
				...
				String[] validationResult = ManagedCollectionSuite.verifyReadAccessRightForManagedCollection(objectType, Config.fetchContainerOrLibrary(currentTemplate),currentTemplate, ADVANCE_SEARCH_BY_NAME);
		...
		String[] validationResult = ManagedCollectionSuite.verifyModifyAccessRightForManagedCollection(objectType, Config.fetchContainerOrLibrary(currentTemplate),currentTemplate, ADVANCE_SEARCH_BY_NAME);
	...
	if (deleteAccess.equalsIgnoreCase("NA")) {
		...
		String[] validationResult = ManagedCollectionSuite.verifyDeleteAccessRightForManagedCollection(objectType,Config.fetchContainerOrLibrary(currentTemplate),currentTemplate, ADVANCE_SEARCH_BY_NAME);
		...
		// Create by move Access Permission is Not Applicable for Managed Collection
	...
	extent.flush();			
		...
		// Download Access Permission is Not Applicable for Managed Collection
	...
	extent.flush();
		...
		// Modify Identity Access Permission is Not Applicable for Managed Collection
	...
	extent.flush();
		...
		//Modify Content Access Permission is Not Applicable for Managed Collection
		...
		// revise Access Permission is Not Applicable for Managed Collection
		...
		// Set State Access Permission is Not Applicable for Managed Collection
		...
		// Change Context Access Permission is Not Applicable for Managed Collection
		...
		// Change Domain Access Permission is Not Applicable for Managed Collection	
