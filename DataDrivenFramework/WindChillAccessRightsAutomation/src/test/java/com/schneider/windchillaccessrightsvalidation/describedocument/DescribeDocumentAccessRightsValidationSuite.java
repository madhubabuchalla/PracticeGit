...
/**
 * @author MADHUBABU 31-Oct-2016
 */
public class DescribeDocumentAccessRightsValidationSuite {
	
	static Logger log = Logger.getLogger("DescribeDocumentAccessRightsValidationSuite");
	public static String  objectType = Config.DESCRIBE_DOCUMENT;
	String[] createAccessRight = new String[2];
	String createOption = "";
	static boolean readAccessRight = false;
	static String objectName = Config.DESCRIBE_DOCUMENT_NAME;
	

	 WindChillAccessRightsValidationUtil windChillUtil = new WindChillAccessRightsValidationUtil();

		
	public String[] verifyCreateAccessRightForDescribeDocument() throws IOException, InterruptedException {
		...
		log.info("AccessRight is : "+ createAccessRight);
		log.info("Create validation Script Executed and returned the result as : "+ createAccessRight);
	...
	public String[] verifyReadAccessRightForDescribeDocument(String ADV_OBJECT_TYPE,String ADV_SEARCH_CONTAINER_NAME, String currentTemplate, String ADV_SEARCH_STATE_STATUS, String ADV_SEARCH_BY_NAME) throws InterruptedException {
	...
	public String[] verifyDownloadAccessRightForDescribeDocument(String ADV_OBJECT_TYPE,String ADV_SEARCH_CONTAINER_NAME, String currentTemplate, String ADV_SEARCH_STATE_STATUS, String ADV_SEARCH_BY_NAME) throws InterruptedException {
	...
	public String[] verifyModifyAccessRightForDescribeDocument(String ADV_OBJECT_TYPE,String ADV_SEARCH_CONTAINER_NAME, String currentTemplate, String ADV_SEARCH_STATE_STATUS, String ADV_SEARCH_BY_NAME) throws InterruptedException{
	...
	public String[] verifyModifyIdentityAccessRightForDescribeDocument(String ADV_OBJECT_TYPE,String ADV_SEARCH_CONTAINER_NAME, String currentTemplate, String ADV_SEARCH_STATE_STATUS, String ADV_SEARCH_BY_NAME) throws InterruptedException{
	...
	public String[] verifyModifyContentAccessRightForDescribeDocument(String ADV_OBJECT_TYPE,String ADV_SEARCH_CONTAINER_NAME, String currentTemplate, String ADV_SEARCH_STATE_STATUS, String ADV_SEARCH_BY_NAME) throws InterruptedException{
	...
	public String[] verifyReviseAccessRightForDescribeDocument(String ADV_OBJECT_TYPE,String ADV_SEARCH_CONTAINER_NAME, String currentTemplate, String ADV_SEARCH_STATE_STATUS, String ADV_SEARCH_BY_NAME) throws InterruptedException {
	...
	public String[] verifySetStateAccessRightForDescribeDocument(String ADV_OBJECT_TYPE,String ADV_SEARCH_CONTAINER_NAME, String currentTemplate, String ADV_SEARCH_STATE_STATUS, String ADV_SEARCH_BY_NAME) throws InterruptedException{
	...
	public String[] verifyDeleteAccessRightForDescribeDocument(String ADV_OBJECT_TYPE,String ADV_SEARCH_CONTAINER_NAME, String currentTemplate, String ADV_SEARCH_STATE_STATUS, String ADV_SEARCH_BY_NAME) throws InterruptedException{
	...
	public String[] verifyChangeDomainAccessRightForDescribeDocument(String ADV_OBJECT_TYPE,String ADV_SEARCH_CONTAINER_NAME, String currentTemplate, String ADV_SEARCH_STATE_STATUS, String ADV_SEARCH_BY_NAME) throws InterruptedException{
...
public String[] verifyChangeContextAccessRightForDescribeDocument(String ADV_OBJECT_TYPE,String ADV_SEARCH_CONTAINER_NAME, String currentTemplate, String ADV_SEARCH_STATE_STATUS, String ADV_SEARCH_BY_NAME) throws InterruptedException{
