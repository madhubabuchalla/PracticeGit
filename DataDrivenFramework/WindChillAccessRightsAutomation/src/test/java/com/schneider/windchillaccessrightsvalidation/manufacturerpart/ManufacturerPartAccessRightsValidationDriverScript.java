...
public class ManufacturerPartAccessRightsValidationDriverScript extends ReportGenerator{
static Logger log = Logger.getLogger(ManufacturerPartAccessRightsValidationDriverScript.class);
private static ExtentTest report = null;
private String objectType = Config.MANUFACTURER_PART;
...
String ADVANCE_SEARCH_BY_NAME = Config.MANUFACTURER_PART_NAME;
...
String excelInput = Config.SSO_NEXTGEN_ACCESS_RIGHTS_MANAGEMENT_RESULT_FILE_PATH_MANUFACTURER_PART;
...
@Test
public void TestAllAccessRightsAutomationForManufacturerPart() throws Exception {
	
	log.info("####################### "+objectType+ "Driver Script execution started  ##################################"  );
	
	
	int initialRowNumber = Config.manufacturerPartSuiteInitialRowNumber-1;
	...
	//	String AdministrativeAccess = excel.getData(Object, i, "Administrative").trim();
		...
		String[] validationResult  = manufaturerPartSuite.verifyCreateAccessRightForManufacturerPart(objectType);
...
// Read Access Validation Script will execute 
		...
		String[] validationResult  = manufaturerPartSuite.verifyReadAccessRightForManufacturerPart(objectType,Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, status, ADVANCE_SEARCH_BY_NAME);
...
// Modify Identity Access Validation Script will execute
				...
				String[] validationResult  = manufaturerPartSuite.verifyModifyIdentityAccessRightForManufacturerPart(objectType,Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, status, ADVANCE_SEARCH_BY_NAME);
...
// Modify Access Validation Script will execute 
				...
				String[] validationResult  = manufaturerPartSuite.verifyModifyAccessRightForManufacturerPart(objectType,Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, status, ADVANCE_SEARCH_BY_NAME);
...
// Revise Access Validation Script will execute 
			...
			if (reviseAccess.equalsIgnoreCase("NA")) {
				...
				String[] validationResult  = manufaturerPartSuite.verifyReviseAccessRightForManufacturerPart(objectType,Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, status, ADVANCE_SEARCH_BY_NAME);
...
// Set State Access Validation Script will execute 
		...
		extent.flush();			
			...
			String[] validationResult  = manufaturerPartSuite.verifySetStateAccessRightForManufacturerPart(objectType,Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, status, ADVANCE_SEARCH_BY_NAME);
...
// Delete Access Validation Script will execute 
			...
			String[] validationResult  = manufaturerPartSuite.verifyDeleteAccessRightForManufacturerPart(objectType,Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, status, ADVANCE_SEARCH_BY_NAME);
	...
	// Change Domain Access Validation Script will execute 
		...
		if (changeDomainAccess.equalsIgnoreCase("NA")) {
			...
			String[] validationResult = manufaturerPartSuite.verifyChangeDomainAccessRightForManufacturerPart(objectType, Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, status, ADVANCE_SEARCH_BY_NAME);
...
// Change Context Access Validation Script will execute 
	...
	if (changeContextAccess.equalsIgnoreCase("NA")) {
		...
		String[] validationResult  = manufaturerPartSuite.verifyChangeContextAccessRightForManufacturerPart(objectType,Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, status, ADVANCE_SEARCH_BY_NAME);
