 ...
 * 
 */
package com.schneider.windchillaccessrightsvalidation.mountingcontextpart;
 ...
 * 28-Nov-2016
 */
public class MountingContextPartAccessRightValidationDriverScript extends ReportGenerator {
	
	static Logger log = Logger.getLogger(MountingContextPartAccessRightValidationDriverScript.class);
	private static ExtentTest report = null;
	String objectType = Config.MOUNTING_CONTEXT_PART;
	...
	String ADVANCE_SEARCH_BY_NAME = Config.MOUNTING_CONTEXT_PART_NAME;
	...
	String excelInput = Config.SSO_NEXTGEN_ACCESS_RIGHTS_MANAGEMENT_RESULT_FILE_PATH_MOUNTING_CONTEXT_PART;
	...
	@Test
	public void TestAllAccessRightsAutomationForMountingContextPart() throws Exception {
		log.info("####################### "+objectType+ "Driver Script execution started  ##################################");
		
		int initialRowNumber = Config.mountingContextPartSuiteInitialRowNumber-1;
		...
		String comment = "Create :  The Create access right is marked with NA Hence 'CREATE' Script has been Skipped ";
			...
			String[] validationResult  = MountingContextPartSuite.verifyCreateAccessRightForMountingContextPart();
	...
	// Read Access Validation Script will execute 
			...
			String[] validationResult  = MountingContextPartSuite.verifyReadAccessRightForMountingContextPart(objectType,Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, status, ADVANCE_SEARCH_BY_NAME);
	...
	// Modify Identity Access Validation Script will execute
					...
					String[] validationResult  = MountingContextPartSuite.verifyModifyIdentityAccessRightForMountingContextPart(objectType,Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, status, ADVANCE_SEARCH_BY_NAME);
	...
	// Modify Access Validation Script will execute 
					...
					String[] validationResult  = MountingContextPartSuite.verifyModifyAccessRightForMountingContextPart(objectType,Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, status, ADVANCE_SEARCH_BY_NAME);
	...
	// Revise Access Validation Script will execute 
				...
				if (reviseAccess.equalsIgnoreCase("NA")) {
					...
					String[] validationResult  = MountingContextPartSuite.verifyReviseAccessRightForMountingContextPart(objectType,Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, status, ADVANCE_SEARCH_BY_NAME);
	...
	// Set State Access Validation Script will execute 
			...
			extent.flush();			
				...
				String[] validationResult = MountingContextPartSuite.verifySetStateAccessRightForMountingContextPart(objectType,Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, status, ADVANCE_SEARCH_BY_NAME);
		...
		// Delete Access Validation Script will execute 
				...
				String[] validationResult = MountingContextPartSuite.verifyDeleteAccessRightForMountingContextPart(objectType,Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, status, ADVANCE_SEARCH_BY_NAME);
		...
		// Change Context Access Validation Script will execute 
			...
			if (changeContextAccess.equalsIgnoreCase("NA")) {
				...
				String[] validationResult = MountingContextPartSuite.verifyChangeContextAccessRightForMountingContextPart(objectType,Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, status, ADVANCE_SEARCH_BY_NAME);
		...
		// Change Domain Access Validation Script will execute 
				...
				String[] validationResult = MountingContextPartSuite.verifyChangeDomainAccessRightForMountingContextPart(objectType,Config.fetchContainerOrLibrary(currentTemplate), currentTemplate, status, ADVANCE_SEARCH_BY_NAME);
			...
			// Create by move Access Permission is Not Applicable for Mounting Context Part
			String createByMoveComment = "Create by move access right is NA for all object types. You can't test it directly and it is internal access right for Change Domaian and Change Context";
				...
				extent.flush();
			// Download Access Permission is Not Applicable for Mounting Context Part
			String downloadComment = "Download access right is NA for " + objectType+ " Hence 'DOWNLOAD' Script has been Skipped";
					...
					extent.flush();
			//Modify Content Access Permission is Not Applicable for Mounting Context Part
