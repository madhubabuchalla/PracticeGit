...
public class ExecutionWithoutProcessingExcel extends ReportGenerator {

private static Logger log = Logger.getLogger(ExecutionWithoutProcessingExcel.class);
private static ExtentTest report = null;
private String objectType = Config.OBJECT_NAME;
private String sheetName = "ACL";
...
ExcelUtil excel = null;
 ...
 String excelInput = "C:\\Users\\SESA439753\\Desktop\\Schneider Requirement Documents\\Next Gen PDM Program Wave 1 FSD Access Rights Management.V10_Copy2.xls";
...
int initialRowNumber = Config.allSuiteInitialRowNumber-1;
...
log.info("####################### Execution Started for the Row Number "+ (i+1) +" in " +objectType+" Sheet ##################################"  );
	...
	if (loggedInUserRole.equalsIgnoreCase(Config.SSO_USER_ROLE)){
		 ...
		 Thread.sleep(2000);
			...
			if(objectName.equals(Config.OBJECT_NAME)&&(currentRole.equals(Config.SSO_USER_ROLE))){
			
			log.info("In row number "+ (i+1) + " Object name and Role is matched hence execution of all validation scripts will be started");
	...
	if(excel.getData(sheetName, i, "Status").trim().equals("All")){
		status = Config.STATUS_ALL;
...
// Expected Access Rights mapped in the Input Excel 
	...
	log.info("###################  Create validation Script Execution Started for "+objectName+" ###############################  ");
	...
	log.info("###################  Create validation Script Execution Completed for "+objectName+" ###############################  ");
	...
	log.info("###################  Read validation Script Execution Started for "+objectName+" ###############################  ");
	...
	log.info("###################  Read validation Script Execution Completed for "+objectName+" ###############################  ");
	...
	log.info("###################  Download validation Script Execution Started for "+objectName+" ###############################  ");
	...
	log.info("###################  Download validation Script Execution Completed for "+objectName+" ###############################  ");
	...
	log.info(" ###################  Modify Content validation Script Execution Started for "+objectName+" ############################### ");
	...
	log.info(" ###################  Modify Content validation Script Execution completed for "+objectName+" ############################### ");
	...
	log.info("###################  Modify Identity validation Script execution Started for "+objectName+" ###############################  ");
	...
	log.info("###################  Modify Identity validation Script Execution completed for "+objectName+" ###############################  ");
...
//Modify Access Validation Script will execute 
	...
	log.info("###################  Modify validation Script Execution Started for "+objectName+" ###############################  ");
...
if (modifyAccess.equalsIgnoreCase("NA")) {
   ...
   log.info("###################  Modify validation Script execution completed for "+objectName+" ###############################  ");
  ...
  Thread.sleep(2000);
	...
	log.info("###################  Revise validation Script Execution Started for "+objectName+" ###############################  ");
	...
	log.info("###################  Revise validation Script Execution Completed for "+objectName+" ###############################  ");
	...
	log.info(" ###################  Set State validation Script Execution Started for "+objectName+" ############################### "); 
	...
	log.info(" ###################  Set State validation Script Execution completed for "+objectName+" ############################### ");
	...
	log.info(" ###################  Delete validation Script Execution Started for "+objectName+" ############################### ");
	...
	log.info(" ###################  Delete validation Script Execution Completed for "+objectName+" ############################### ");
...
// Change Domain Access Validation Script will execute 
		 ...
		 log.info(" ###################  Change Domain validation Script Execution Started for "+objectName+" ############################### ");
...
log.info(" ###################  Change Domain validation Script Execution completed for "+objectName+" ############################### ");
...
GenericFunctionLibrary.refreshWindow();
 ...
 Thread.sleep(2000);
	...
	log.info(" ###################  Change Context validation Script Execution Started for "+objectName+" ############################### ");
	...
	log.info(" ###################  Change Context validation Script Execution Completed for "+objectName+" ############################### ");
	...
	// Create by move Access Permission is Not Applicable for All Object Types
        ...
        extent.flush();
			...
			String comment = "Object Name and Role is not a required match in this Row number " +(i+1);
				log.info(comment);
